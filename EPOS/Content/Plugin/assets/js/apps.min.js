...
var handleMobileSidebarToggle = function() {
    var e = false;
    $(document).on("click touchstart", ".sidebar",
    function(t) {
...
var handlePanelAction = function() {
    ...
    $("[data-click=panel-remove]").click(function (e) {
        $(window.top.document.getElementById("mainFrame")).removeClass('fiex');
        $(window.top.document.getElementById("mainFrame")).css('height', top.document.documentElement.clientHeight - 54);
        $("body, .panel").removeClass("panel-expand");
        
        var i=$("#contheight>div>div").length;
        e.preventDefault();
        $(this).tooltip("destroy"); 
        var mapheight=$("#contheight").height();
        if(mapheight<=429)
        {
            i--;
            var lei="col-lg-"+12/i;
                    
            $(this).closest(".panel").parent().siblings().removeClass().addClass(lei);
        
        } 

        $(this).closest(".panel").parent().hide(500);
    ...
    $("[data-click=panel-collapse]").hover(function () {
        $("[data-click=panel-collapse]").tooltip('destroy')
        if ($(this).closest(".panel").find(".panel-body").css("display")=='block') {
        $(this).tooltip({
            title: "收起",
            placement: "bottom",
            trigger: "hover",
    ...
    $("[data-click=panel-collapse]").click(function(e) {
        ...
        //function () {
        //    $("[data-click=panel-collapse]").tooltip('destroy')
        //    if ($(thisown).closest(".panel").find(".panel-body").css("display") == 'block') {
        //        $(thisown).tooltip({
        //            title: "收起",
        //            placement: "bottom",
        //            trigger: "click"
    ...
    $("[data-click=panel-expand]").hover(function () {
        $(this).tooltip('destroy');
        if ($(window.top.document.getElementById("mainFrame")).hasClass("fiex")) {
    ...
    $("[data-click=panel-expand]").click(function (e) {
        //alert($(this).id);
        $(window.top.document.getElementById("mainFrame")).addClass('fiex');
        $(window.top.document.getElementById("mainFrame")).css('height', top.document.documentElement.clientHeight);
      ...
      //  Hmap.initMapAsyn({ "mapId": "allmap1", "lng": 116.4035, "lat": 39.915, "level": 11, "cityName": "上海" });
    })
};
